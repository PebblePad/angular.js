...
describe('ngOptions', function() {
  ...
  it('should not watch non-numeric array properties', function() {
    ...
    scope.createLabel = jest.fn(function(value) { return value; });
    scope.array = ['a', 'b', 'c'];
    ...
    if (!/\b(9|\d{2})(?:\.\d+)+[\s\S]*safari/i.test(window.navigator.userAgent)) {
      it('should not re-set the `selected` property if it already has the correct value', function() {
        ...
        angular.forEach(options, function(option, i) {
          ...
          optionsSetSelected[i] = jest.fn(setSelected);
  ...
  describe('ngModelCtrl', function() {
    ...
    it('should fail validation when $asyncValidators fail', angular.mock.inject(function($q, $rootScope) {
      var defer;
      createSelect({
        'name': 'select',
        'ng-model': 'value',
    ...
    it('should pass validation when $asyncValidators pass', angular.mock.inject(function($q, $rootScope) {
      var defer;
      createSelect({
        'name': 'select',
        'ng-model': 'value',
