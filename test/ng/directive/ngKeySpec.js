...
describe('ngKeyup and ngKeydown directives', function() {
  ...
  it('should get called on a keyup', angular.mock.inject(function($rootScope, $compile) {
  ...
  it('should get called on a keydown', angular.mock.inject(function($rootScope, $compile) {
  ...
  it('should get called on a keypress', angular.mock.inject(function($rootScope, $compile) {
